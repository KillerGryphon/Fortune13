...
#define SUPERMUTANTS (1<<12)

#define F13NCRSUPERMUTANT (1<<0)
#define F13SMRAIDER (1<<1)
#define F13SMWASTELANDER (1<<2)
...
#define JOB_DISPLAY_ORDER_NCRSUPERMUTANT 115
#define JOB_DISPLAY_ORDER_SMRAIDER 116
#define JOB_DISPLAY_ORDER_SMWASTELANDER 117
